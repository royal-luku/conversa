...
from database.userschat import Database
...
async def handle_media(client, message):
    try:
        if message.photo:
            if message.caption:  # If caption is available
            ...
            else:  # If no caption is provided
                # Reply asking the user to provide a caption with a tutorial button
                tutorial_button = InlineKeyboardButton("📖 Tutorial", url="https://example.com/tutorial")  # Replace with actual tutorial URL
                ...
                return  # Exit the function if no caption is provided

            # Proceed with image processing if caption is provided
